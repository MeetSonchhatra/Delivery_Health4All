import 'package:delivery_health4all/Courier-side/Main-Pages/Home1.dart';
...
class OTPD extends StatefulWidget {
  const OTPD({super.key, required this.phone, required this.password});
final String phone;
            ...
            children: [
              ...
              ElevatedButton(
                  ...
                  String fOtp = otp1.text +
                      ...
                      otp6.text;
                  if (fOtp == "123456") {
                    DeliveryLogin_Model data = await LoginDApi().loginDList(int.parse(widget.phone) ,int.parse(widget.password) );
